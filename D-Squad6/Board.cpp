...
int Board::isSuperTowerButtonClicked(){
    return superTowerButton;
}
...
void Board::addEnemy(char type) { // adds an enemy onto the board
    ...
    else if (type=='o') // if a boss enemy is chosen
        enemyList.push_back(new Boss(1, 0, wave)); // make a boss 
