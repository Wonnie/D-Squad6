...
**
** Created: Fri Dec 13 15:03:13 2013
...
static const char qt_meta_stringdata_MyPaint[] = {
    "MyPaint\0"
};
...
const QMetaObjectExtraData MyPaint::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject MyPaint::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MyPaint,
      qt_meta_data_MyPaint, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &MyPaint::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_MyPaint))
